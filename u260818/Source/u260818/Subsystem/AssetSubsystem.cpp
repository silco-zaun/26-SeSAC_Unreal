...
void UAssetSubsystem::LoadItem()
{
	UAssetManager& AssetManager = UAssetManager::Get();

	FPrimaryAssetId AssetId(TEXT("PlayerInfoAsset"), TEXT("DA_ItemInfo"));

	AssetManager.LoadPrimaryAsset(AssetId, TArray<FName>(),
		FStreamableDelegate::CreateUObject(this, &UAssetSubsystem::ItemInfoLoadComplete, AssetId));
}
